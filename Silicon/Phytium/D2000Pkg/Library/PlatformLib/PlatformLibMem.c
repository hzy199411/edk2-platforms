  ...
  )
{
  ...
  //Flash Space
  VirtualMemoryTable[Index].PhysicalBase   = PcdGet64 (PcdSpiFlashBase);
  VirtualMemoryTable[Index].VirtualBase    = PcdGet64 (PcdSpiFlashBase);
  VirtualMemoryTable[Index].Length         = PcdGet64 (PcdSpiFlashSize);
